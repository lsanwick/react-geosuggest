...
var Geosuggest = function (_React$Component) {
  ...
  function Geosuggest(props) {
    ...
    if (props.debounce) {
      _this.onAfterInputChange = (0, _lodash.debounce)(_this.onAfterInputChange, props.debounce);
    }
    return _this;
  }
  ...
  _createClass(Geosuggest, [{
    ...
    value: function searchSuggests() {
      ...
      this.autocompleteService.getPlacePredictions(options, function (suggestsGoogle) {
        ...
        if (_this2.props.autoActivateFirstSuggest) {
...
},{"./defaults":4,"./filter-input-attributes":5,"./input":6,"./prop-types":7,"./suggest-list":9,"classnames":1,"lodash":2}],4:[function(require,module,exports){
'use strict';
...
var SuggestList = function (_React$Component) {
  ...
  _createClass(SuggestList, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('geosuggest__suggests', { 'geosuggest__suggests--hidden': this.props.isHidden });
